...
<html lang="en">
	<head>
	    ...
	    <title>Shopping Portal BILWI Home Page</title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over C$. 600.00</h6>	
				</div>
			</div><!-- .col -->
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					C$.<?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">C$.<?php echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>
